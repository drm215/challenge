        ...
        <table id="selection-data" style="width: 270px; table-layout: fixed;">
            ...
            <tbody>
                <tr id="qb-row" class="highlight">
									<td><a class="toggle-position" id="QB">QB</a></td>
                ...
                <tr id="rb1-row">
									<td><a class="toggle-position" id="RB1">RB1</a></td>
                ...
                <tr id="rb2-row">
									<td><a class="toggle-position" id="RB2">RB2</a></td>
                ...
                <tr id="wr1-row">
									<td><a class="toggle-position" id="WR1">WR1</a></td>
                ...
                <tr id="wr2-row">
									<td><a class="toggle-position" id="WR2">WR2</a></td>
                ...
                <tr id="f-row">
									<td><a class="toggle-position" id="F">F</a></td>
                ...
                <tr id="k-row">
									<td><a class="toggle-position" id="K">K</a></td>
                ...
                <tr id="d-row">
									<td><a class="toggle-position" id="D">D</a></td>
