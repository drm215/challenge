        ...
        <table id="selection-data" style="width: 270px; table-layout: fixed;">
            ...
            <tbody>
                <tr id="qb-row" class="highlight">
									<td><?php echo isset($userentry['QB']['locked']) && $userentry['QB']['locked'] == 1 ? 'QB' : '<a class="toggle-position" id="QB">QB</a>'; ?></td>
                ...
                <tr id="rb1-row">
									<td><?php echo isset($userentry['RB1']['locked']) && $userentry['RB1']['locked'] == 1 ? 'RB1' : '<a class="toggle-position" id="RB1">RB1</a>'; ?></td>
                ...
                <tr id="rb2-row">
									<td><?php echo isset($userentry['RB2']['locked']) && $userentry['RB2']['locked'] == 1 ? 'RB2' : '<a class="toggle-position" id="RB2">RB2</a>'; ?></td>
                ...
                <tr id="wr1-row">
									<td><?php echo isset($userentry['WR1']['locked']) && $userentry['WR1']['locked'] == 1 ? 'WR1' : '<a class="toggle-position" id="WR1">WR1</a>'; ?></td>
                ...
                <tr id="wr2-row">
									<td><?php echo isset($userentry['WR2']['locked']) && $userentry['WR2']['locked'] == 1 ? 'WR2' : '<a class="toggle-position" id="WR2">WR2</a>'; ?></td>
                ...
                <tr id="f-row">
									<td><?php echo isset($userentry['F']['locked']) && $userentry['F']['locked'] == 1 ? 'F' : '<a class="toggle-position" id="F">F</a>'; ?></td>
                ...
                <tr id="k-row">
									<td><?php echo isset($userentry['K']['locked']) && $userentry['K']['locked'] == 1 ? 'K' : '<a class="toggle-position" id="K">K</a>'; ?></td>
                ...
                <tr id="d-row">
									<td><?php echo isset($userentry['D']['locked']) && $userentry['D']['locked'] == 1 ? 'D' : '<a class="toggle-position" id="D">D</a>'; ?></td>
